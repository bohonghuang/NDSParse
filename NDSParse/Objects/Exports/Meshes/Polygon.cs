...
{
    public string Name;
    public MDL0PolygonInfo Info;
    public List<MDL0PolygonCommand> Commands = [];
}

public class MDL0PolygonInfo : Deserializable
{
    public ushort Tag;
    ...
    public override void Deserialize(BaseReader reader)
    {
        ...
        var length = reader.Read<ushort>(); // always 16?
...
public class MDL0PolygonCommand
{
    public PolygonCommandOpCode OpCode;
    public int[] Parameters;

    public MDL0PolygonCommand(PolygonCommandOpCode opCode, params int[] parameters)
    {
        OpCode = opCode;
        Parameters = parameters;
    }
    
    public static int GetParameterCount(PolygonCommandOpCode command)
    {
